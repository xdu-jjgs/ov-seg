...
from .reins_vit import ReinsVisualTransformer
from .timm_model import TimmModel
from .utils import to_2tuple
from .vit import LayerNorm, QuickGELU, ModifiedResNet, VisualTransformer, Transformer
...
class CLIPVisionCfg:
    ...
    reins: bool = False  # use rein
    reins_return_query: bool = False
...
class CLIP(nn.Module):
    def __init__(
        ...
        elif vision_cfg.reins:
            vision_heads = vision_cfg.width // vision_cfg.head_width
            self.visual = ReinsVisualTransformer(
                image_size=vision_cfg.image_size,
                ...
                reins_return_query=vision_cfg.reins_return_query
            )
        else:
            vision_heads = vision_cfg.width // vision_cfg.head_width
